...
package controls
{
	...
	import controls.skins.MapServiceLegend_orig;
	...
	public class controls.MapServiceLegend_orig extends spark.components.SkinnableContainer
	{
		...
		override public function stylesInitialized():void {  
			...
			this.setStyle("skinClass",Class(controls.skins.MapServiceLegend_orig));
		}
